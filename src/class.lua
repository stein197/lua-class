	...
	setmetatable(descriptor, {
		...
		__call = function (...)
			...
			local object = setmetatable({}, {
				__index = parent,
				__newindex = parent.__newindex or parent["[]"],
				__call = parent.__call or parent["()"],
				__tostring = parent.__tostring,
				__concat = parent.__concat or parent[".."],
				__metatable = parent.__metatable,
				__mode = parent.__mode,
				__gc = parent.__gc,
				__len = parent.__len or parent["#"],
				__pairs = parent.__pairs,
				__ipairs = parent.__ipairs,
				__add = parent.__add or parent["+"],
				__sub = parent.__sub or parent["-"],
				__mul = parent.__mul or parent["*"],
				__div = parent.__div or parent["/"],
				__pow = parent.__pow or parent["^"],
				__mod = parent.__mod or parent["%"],
				__idiv = parent.__idiv or parent["//"],
				__eq = parent.__eq or parent["=="],
				__lt = parent.__lt or parent["<"],
				__le = parent.__le or parent["<="],
				__band = parent.__band or parent["&"],
				__bor = parent.__bor or parent["|"],
				__bxor = parent.__bxor or parent["~"],
				__bnot = parent.__bnot or parent["not"],
				__bshl = parent.__bshl or parent["<<"],
				__bshr = parent.__bshr or parent[">>"]
			})
